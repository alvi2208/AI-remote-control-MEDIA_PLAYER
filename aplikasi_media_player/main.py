# Create Media Player Simple GUI
# Create Menus with PyQt5 and Python3
# Create Button Open File, Play Or Pause, and Stop
# Create Button Forward, Backward, Mute Or Unmute, and Volume Up Or Down
# added sleep time feature to turn off video after a certain time
# Create Slider Video
...
class Window(QMainWindow):
    def __init__(self):
        ...
        tools_menu.addAction(hand_gesture_action)
    ...
    def update_app(self):
        mbox.showinfo("Fitur Terbaru Versi: 1.0.10", "- Fitur MenuBar\n" "- Durasi Video\n" "- Penambahan Fitur Borderless\n"
...
# Membuat Class Untuk Hand Gesture Detection - Control Media Player
# Jika Tangan Angka 1 Maka Media Player Akan Menekan Space
# Jika Tangan Angka 2 Maka Media Player Akan Menekan Tombol left
# Jika Tangan Angka 3 Maka Media Player Akan Menekan Tombol Right
# Jika Tangan Angka 4 Maka Media Player Akan Menekan Tombol f
# Jika Tangan Angka 5 Maka Media Player Akan Menekan Tombol m
'''
contoh Program:
import cv2
import mediapipe as mp
